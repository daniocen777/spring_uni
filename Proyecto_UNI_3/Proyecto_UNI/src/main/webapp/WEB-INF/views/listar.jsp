					...
					<div class="row">
						<div class="col-md-3">
							<div class="form-group">
								<label for="varchar">Búsqueda:</label> <input type="text"
									class="form-control" placeholder="Ingrese Nombre de Empleado"
									value="" />
							</div>
						</div>
						<br>
							...
							<tbody>
								...
								<c:forEach items="${lista}" var="r">
									<tr>
										...
										<td><a data-original-title="Ver"
											href="verEmpleado.htm?codigo=${r.idEmpleado}"
											data-toggle="tooltip" data-placement="top" title=""><span
												class="glyphicon glyphicon-eye-open"></span></a> <a
											data-original-title="Eliminar"
											href="eliminarEmpleado.htm?id=${r.idEmpleado}"
											data-toggle="tooltip" data-placement="top" title=""><span
