...
public class EmpleadoControleer {
	...
	@RequestMapping(value = "/verEmpleado.htm", method = RequestMethod.GET)
	public String verEmpleado(@RequestParam("codigo") int idEmpleado, Model model) {
		try {
			model.addAttribute("bean", empleadoService.getEmpleadoPorId(idEmpleado));
		} catch (Exception e) {
	...
	// UPDATE
	@RequestMapping(value = "/verEmpleado.htm", method = RequestMethod.POST)
	public String actualizar(@RequestParam("codigo") int idEmpleado, @RequestParam("nombreRegion") String region,
			@RequestParam("nombrePais") String pais, @RequestParam("nombreCalle") String calle,
			@RequestParam("codigoPostal") String codigoPostal, @RequestParam("ciudad") String ciudad,
			@RequestParam("provincia") String provincia, @RequestParam("nombreDepartamento") String departamento,
			@RequestParam("nombre") String nombre, @RequestParam("apPaterno") String apPaterno,
			@RequestParam("apMaterno") String apMaterno, @RequestParam("email") String email,
			@RequestParam("telefono") String telefono, @RequestParam("fechaNac") String fechaNac,
			@RequestParam("salario") float salario, Model model) {
		try {
			empleadoService.modificarEmpleado(idEmpleado, region, pais, calle, codigoPostal, ciudad, provincia,
					departamento, nombre, apPaterno, apMaterno, email, telefono, fechaNac, salario);
		} catch (Exception e) {
			model.addAttribute("error", e.getMessage());
		}
		return "home";
