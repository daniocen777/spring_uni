package pe.daniel.app.dao.mapper;
...
// ESTA CLASE SE CREA PARA OBTENER LOS DATOS DE UN CLIENTE, PERO SE PUEDE HACER
// LO MISMO SIN UTIIZAR ESTA CLASE. 
// SE IMPLEMENTA EL ROWMAPPER
public class ClienteMapper implements RowMapper<Cliente> {
	...
	public Cliente mapRow(ResultSet rs, int n) throws SQLException {
		...
		bean.setEemail(rs.getString("vch_clieemail"));
		return bean;
	}
